...
-- Зарабатываем $1 при каждом добавлении и удалении. Пусть сумма длин списков front и rear равна N. На балансировку очереди тратится $N, накопленных в списках front и rear.

--  Метод физика 

--- Потенциал – это сумма размеров списков front и rear. Пусть сумма длин списков front и rear равна N. Добавление без балансировки очереди увеличивает φ на 1. Удаление без балансировки очереди не меняет φ. Балансировка очереди увеличивает φ на N. 
